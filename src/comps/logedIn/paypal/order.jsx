...
export const PaypalModal = ({
        ...
        .Buttons({
          ...
          onApprove: async (data, actions) => {
            ...
            if (orderObj.status === "COMPLETED") {
              console.log("Paypal: orderObj", orderObj);
              if (orderObj.kindOfPayment === "Abo") {
                console.log("Paypal: logedUserData", logedUserData);
                console.log("Paypal: orderObj.group", orderObj.group);
              }
            }
  ...
  return (
    <div className="modalBG" ref={paypal}>
      ...
      Zahlungshöhe:{" "}
      {paymentValueRef.current?.value > 1.98
        ? paymentValueRef.current.value
        : "Erfüllt nicht den Mindestbetrag"}{" "}
      <br />
      Rythmus: {rythm}
      <br />
      <br />
