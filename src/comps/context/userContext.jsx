...
export const UserProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    logedUserData
      ? localStorage.setItem("logedUserData", JSON.stringify(logedUserData))
      : localStorage.removeItem("logedUserData");
  }, [loginToken]);

  return (
    <AppContext.Provider
      value={{ loginToken, setLoginToken, logedUserData, setLogedUserData }}
    >
      {children}
    </AppContext.Provider>
  );
